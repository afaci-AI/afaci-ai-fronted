    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-6">
        ...
        <p className="mt-2 text-muted-foreground">
          Расчёт по методике Липатова: макросостав, аминокислотный скор и
          качественные показатели рецептуры.
        </p>
      </div>
            ...
            <CardHeader>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <CardDescription>
                    Подберите ингредиенты из банка данных и задайте массу Xᵢ.
                    База рецептуры — 100 г.
                  </CardDescription>
                </div>
            ...
            <CardContent className="space-y-5">
              <div className="flex flex-wrap items-end gap-3">
                <div className="grow max-w-md">
                  <Label className="mb-1.5 block">
                    Эталонный белок (шкала скора)
                  </Label>
                  <Select value={refId} onValueChange={setRefId}>
                    <SelectTrigger>
                      <SelectValue placeholder="Выберите эталон" />
                    </SelectTrigger>
                    <SelectContent>
                      {references.map((r) => (
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!sumValid && (
                      <span className="text-destructive flex items-center gap-1 text-xs">
                        <AlertTriangle className="h-3.5 w-3.5" /> сумма должна
                        быть ровно 100 г
                      </span>
                    )}
              ...
              {!sumValid && (
                <p className="text-muted-foreground text-xs">
                  Пока сумма ≠ 100 г, расчёт заблокирован, но рецептуру можно
