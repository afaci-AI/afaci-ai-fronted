...
export default function DashboardPage() {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      icon: FlaskConical,
      href: '/dictionaries/nutrient-names',
      ...
      <main className="flex-1 overflow-auto p-4 md:p-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Обзор базы данных продуктов и нутриентов
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <Card className="lg:col-span-2">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle>Недавно обновленные</CardTitle>
                <CardDescription>
                  Последние изменения в продуктах
                </CardDescription>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {canEdit ? 'Добавление и импорт данных' : 'Только просмотр'}
              </CardDescription>
            </CardHeader>
            <CardContent>
              {canEdit ? (
                <div className="space-y-2">
                  ...
                  <Button
                    ...
                    asChild
                  >
                    <Link href="/products?action=import">
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Ваша роль позволяет только просматривать данные.
                </p>
              )}
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
              {[
                ...
                {
                  label: 'Подкатегории',
                  href: '/dictionaries/subcategories',
                  count: '-',
                },
                {
                  label: 'Регионы',
                ...
                },
                {
                  ...
                  href: '/dictionaries/nutrient-types',
                  count: '-',
                },
                {
                  label: 'Названия нутриентов',
                  href: '/dictionaries/nutrient-names',
                  count: stats.nutrients,
                },
                {
