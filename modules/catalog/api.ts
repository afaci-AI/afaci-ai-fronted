...
export const categoriesApi = {
  ...
  bulk: (names: string[]) =>
    fetchApi<Category[]>('/categories/bulk', {
      method: 'POST',
...
export const subcategoriesApi = {
  ...
  delete: (id: string) =>
    fetchApi<void>(`/subcategories/${id}`, { method: 'DELETE' }),
}
...
export const regionsApi = {
  ...
  update: (id: string, data: { name?: string }) =>
    fetchApi<Region>(`/regions/${id}`, {
      method: 'PATCH',
      body: JSON.stringify(data),
    }),
  delete: (id: string) =>
    fetchApi<void>(`/regions/${id}`, { method: 'DELETE' }),
  bulk: (names: string[]) =>
    fetchApi<Region[]>('/regions/bulk', {
      method: 'POST',
      body: JSON.stringify({ names }),
    }),
}
...
export const nutrientTypesApi = {
  ...
  create: (data: { name: string }) =>
    fetchApi<NutrientType>('/nutrient-types', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  update: (id: string, data: { name?: string }) =>
    fetchApi<NutrientType>(`/nutrient-types/${id}`, {
      method: 'PATCH',
      body: JSON.stringify(data),
    }),
  delete: (id: string) =>
    fetchApi<void>(`/nutrient-types/${id}`, { method: 'DELETE' }),
  bulk: (names: string[]) =>
    fetchApi<NutrientType[]>('/nutrient-types/bulk', {
      method: 'POST',
      body: JSON.stringify({ names }),
    }),
}
...
export const nutrientNamesApi = {
  ...
  create: (data: { name: string }) =>
    fetchApi<NutrientName>('/nutrient-names', {
      method: 'POST',
      body: JSON.stringify(data),
    }),
  update: (id: string, data: { name?: string }) =>
    fetchApi<NutrientName>(`/nutrient-names/${id}`, {
      method: 'PATCH',
      body: JSON.stringify(data),
    }),
  delete: (id: string) =>
    fetchApi<void>(`/nutrient-names/${id}`, { method: 'DELETE' }),
  bulk: (names: string[]) =>
    fetchApi<NutrientName[]>('/nutrient-names/bulk', {
      method: 'POST',
      body: JSON.stringify({ names }),
    }),
}
